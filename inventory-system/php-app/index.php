<?php
session_start();
// Error reporting para makita nato kung naay problema sa connection
error_reporting(E_ALL);
ini_set('display_errors', 1);

require_once 'db_config.php'; 

$error = ""; // variable para sa error message

if (isset($_POST['login_btn'])) {
    $email = $_POST['email'];
    $password = $_POST['password'];

    // Query (Siguroha nga ang table name kay 'users')
